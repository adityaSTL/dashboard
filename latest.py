...
##setting dates
yesterday_date=pd.to_datetime(date.today()-timedelta(days=2))
today_date=pd.to_datetime(date.today()-timedelta(days=1))
first_date1=pd.to_datetime(date.today()-timedelta(days=31))
print(first_date1)
first_date=pd.to_datetime((date.today()-timedelta(days=1))).replace(day=1)
print("Dates all set")
##Done
...
namein=str(((date.today()-timedelta(days=1)).strftime('%d-%m-%Y')))
...
namein=str((date.today()-timedelta(days=1)).strftime('%d-%b-%y'))
...
namein=str((date.today()-timedelta(days=1)).strftime('%d-%b-%Y'))
namefull= r"C:\Users\Aditya.gupta\Downloads\POP DPR - PKGC as on "+namein+r" 1.xlsx"
...
namein=str((date.today()-timedelta(days=1)).strftime('%d-%m-%Y'))
namefull= r"C:\Users\Aditya.gupta\Downloads\PKG C AT Tracker "+namein+r".xlsx"
...
print(type(df_atC[r'4-ATC released']))
